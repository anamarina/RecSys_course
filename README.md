...
```
where
Home Assignments - 5 home assignments in Jupyter Notebook (max 10 points). 
Quizzes - 19 weekly quizzes on lecture's and seminars' topics in Google Forms (max 10 points). 
